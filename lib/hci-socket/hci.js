...
Hci.prototype.createLeConn = function (address, addressType) {
  ...
  cmd.writeUInt16LE(0x6, 17); // min interval 0x6
  cmd.writeUInt16LE(0xc, 19); // max interval 0xc
  cmd.writeUInt16LE(0x0000, 21); // latency
  cmd.writeUInt16LE(0x00c8, 23); // supervision timeout 0x00c8 = 200
  cmd.writeUInt16LE(0x0004, 25); // min ce length 0x0004
  cmd.writeUInt16LE(0x0006, 27); // max ce length 0x0006
