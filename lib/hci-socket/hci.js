...
Hci.prototype.createLeConn = function (address, addressType) {
  ...
  const maxInterval = 125;
  const supervisionTimeout = 10000;

  cmd.writeUInt16LE(Math.floor(minInterval / 1.25), 17); // min interval 0x6
  cmd.writeUInt16LE(Math.floor(maxInterval / 1.25), 19); // max interval 0xc
  cmd.writeUInt16LE(0x0000, 21); // latency
  cmd.writeUInt16LE(Math.floor(supervisionTimeout / 10), 23); // supervision timeout 0x00c8 = 200
  cmd.writeUInt16LE(Math.floor(minInterval / 0.625), 25); // min ce length 0x0004
  cmd.writeUInt16LE(Math.floor(maxInterval / 0.625), 27); // max ce length 0x0006
